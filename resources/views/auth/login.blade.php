                                    ...
                                    <div method="POST" action="{{ route('login') }}" class="card-body p-5">
                                        ...
                                        <form method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="email" type="email" class=" form-control form-control-solid py-4 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus />
                                                @error('email')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="password" type="password" class="form-control form-control-solid py-4 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" />
                                                @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
