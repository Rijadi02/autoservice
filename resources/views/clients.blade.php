                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary"
                                                        href="{{ route('cars.index', $client->id) }}">Add car/damage</a>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal fade" id="id{{ $client->id }}" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">This will delete the selected Client
                                                                    and all
