                ...
                @enderror
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input id="zip" type="text" name="zip"
                                            ...
                                            value="{{ old('zip') ?? $user->zip }}" autocomplete="zip">
                                        @error('zip')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input id="tel" type="text" name="tel"
                                            ...
                                            value="{{ old('tel') ?? $user->tel }}" autocomplete="tel">
                                        @error('tel')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input id="currency" type="text" name="currency"
                                            ...
                                            value="{{ old('currency') ?? $user->currency }}" autocomplete="currency">
                                        @error('currency')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input id="tariff" type="text" name="tariff"
                                            class="form-control @error('tariff') is-invalid @enderror"
                                            value="{{ old('tariff') ?? $user->tariff }}" autocomplete="tariff">
                                        @error('tariff')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input id="bank" type="text" name="bank"
                                            ...
                                            value="{{ old('bank') ?? $user->bank }}" autocomplete="bank">
                                        @error('bank')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                ...
                @enderror
                            ...
                            @else
                                ...
                                <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-12">
                                        <label for="password_confirmation" class="col-md-12 col-form-label">Confirm
                                            Password</label>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input id="tariff" type="text" name="tariff"
                                            class="form-control @error('tariff') is-invalid @enderror"
                                            value="{{ old('tariff') }}" autocomplete="tariff">
                                        @error('tariff')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <input id="bank" type="text" name="bank"
                                            class="form-control @error('bank') is-invalid @enderror"
                                            value="{{ old('bank') }}" autocomplete="bank">
                                        @error('bank')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal fade" id="id{{ $user->id }}" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">This will delete the selected User
                                                                    and all
                                                    ...
                                                    <a href="" class="btn btn-datatable btn-icon btn-transparent-dark"
                                                        data-toggle="modal" data-target="#id{{ $user->id }}"><i
