                                    ...
                                    <form method="POST" action="{{ route('cars.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 form-group">
                                                <label for="license" class="col-md-12 col-form-label">License</label>
                                                <input id="license" type="text" name="license" placeholder="License Plate"
                                                    class="form-control @error('license') is-invalid @enderror"
                                                    value="{{ old('license') }}" autocomplete="license">
                                                @error('license')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="chassis" class="col-md-12 col-form-label">Chassis</label>
                                                <input id="chassis" type="text" name="chassis" placeholder="Chassis Number"
                                                    class="form-control @error('chassis') is-invalid @enderror"
                                                    value="{{ old('chassis') }}" autocomplete="chassis">
                                                @error('chassis')
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="weight" class="col-md-12 col-form-label">Weight</label>
                                                <input id="weight" type="text" name="weight" placeholder="Weight (kg)"
                                                    class="form-control @error('weight') is-invalid @enderror"
                                                    value="{{ old('weight') }}" autocomplete="weight">
                                                @error('weight')
                                                    <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="button" onclick="$('#wizard2-tab').trigger('click')" class="btn btn-primary" >Next</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xxl-6 col-xl-8">
                                    ...
                                    <form>
                                        ...
                                        <hr class="my-4" />
                                        <div class="d-flex justify-content-between">
                                            <button class="btn btn-light" type="button" onclick="$('#wizard1-tab').trigger('click')">Previous</button>
                                            <button class="btn btn-primary" type="button" onclick="$('#wizard3-tab').trigger('click')">Next</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xxl-6 col-xl-8">
                                    ...
                                    <form>
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" id="checkSecurity" type="checkbox" checked
                                                disabled />
                                        ...
                                        <hr class="my-4" />
                                        <div class="d-flex justify-content-between">
                                            <button class="btn btn-light" type="button" onclick="$('#wizard2-tab').trigger('click')">Previous</button>
                                            <button class="btn btn-primary" type="button" onclick="$('#wizard4-tab').trigger('click')">Next</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane py-5 py-xl-10 fade" id="wizard4" role="tabpanel" aria-labelledby="wizard4-tab">
                            <div class="row justify-content-center">
                                <div class="col-xxl-6 col-xl-8">
                                    ...
                                    <hr class="my-4" />
                                    <div class="d-flex justify-content-between">
                                        <button class="btn btn-light" type="button" onclick="$('#wizard3-tab').trigger('click')">Previous</button>
