                                    ...
                                    <tr>
                                            ...
                                            @switch(count($car->damages) > 0 ? $car->damages[0]['damage_type'] : "")
                                                @case(1)
                                                    <a class="btn btn-green text-white"
                                                        href="{{ route('cars.damage_hail', $car->id) }}"> Damage</a>
                                        ...
                                        @if (Auth::user()->role_id == 1)
                                            <td><a class="btn btn-secondary"
                                                    href="{{ route('user.invoice', $car->id) }}">Admin Report</a></td>
                                        @else
                                            <td><button class="btn btn-secondary">Report</button></td>

                                        @endif
                                        <td><a class="btn btn-red"
                                                href="{{ route('signaturepad', $car->id) }}">E-signature</a></td>
